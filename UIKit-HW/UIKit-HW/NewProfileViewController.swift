...
class NewProfileViewController: UIViewController {
    ...
    @objc func addInstagramAlert() {
        let instagramAlertController = UIAlertController(title: "Введите имя пользователя", message: nil, preferredStyle: .alert)
        let instagramAlertAction = UIAlertAction(title: "Ok", style: .default) {(action) in
